...
/// Windows zip lands next to the current executable so that the extraction script can overwrite
/// in place. Everything else lands in the system temp directory.
///
/// # Errors
///
